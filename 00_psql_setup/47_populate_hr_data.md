# HR: Populate database

In the previous lesson we defined the `hr` schema database in the `hr-schema.sql` and executed the script in the `psql` prompt.

In this lesson, we populate the `hr` schema database in the `hr-data.sql` and execute the script in the `psql` prompt.
...
-- ********************************
--  Populate the hr databse schema
-- ********************************
